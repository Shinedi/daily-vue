---
title: createElement
date: 2020-10-28 17:32:33
tags:
---

#### createElement
---
_render中`vnode = render.call(vm._renderProxy, vm.$createElement)`调用render函数
```
```
最终返回一个vnode,其实是通过利用 createElement 方法创建 VNode，它定义在 `src/core/vdom/create-element.js` 中：
```
